...
import heroRing from "@/images/Product/MeetAva.png";
...
export const homePage = {
  ...
  productPage: {
    ...
    designToEvolve: {
      ...
      variants: [
        ...
        },
        {
          title: "UnfoldXR Edge",
          subHeading:
            "Define the modern workflow with advanced AI-AR tech and performance intelligence",
          description:
    ...
    fromAssist: {
      ...
      subtitle: "Book a demo to see how UnfoldXR fits your operational stage.",
...
export const partnersPage = {
  ...
  metricsSection: {
    ...
    description:
      "AI and augmented reality are rapidly becoming core to how enterprises operate and scale. Partnering early means aligning with a high-growth market and delivering measurable value to your customers.",
    metrics_card_data: [
      {
        title: "51.8% CAGR",
        description:
...
export const  BlogsInsightsPage = {
 ...
 export const blogData = [
  {
    id: 1,
    title: "Augmented reality overlays for navigation, directions, and notifications",
    desc: "It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout...",
     desc1: " From professionals to everyday users, AI glasses provide seamless digital interaction without interrupting natural vision, offering a perfect balance between technology and human experience  Built with cutting-edge artificial intelligence, modern smart glasses integrate powerful features such as real-time translation, object recognition, and hands-free. ",
     desc2: "These innovations are designed to improve productivity, accessibility, and convenience across various industries and daily life.The future of AI glasses is promising, with advancements in display technology, battery life, and AI capabilities. As these devices become more sophisticated and affordable, they have the potential to revolutionize how we interact with the digital world, making information more accessible and enhancing our ability to connect and communicate seamlessly.",
     date: "May 20th 2020",

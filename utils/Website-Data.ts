...
import ankushImg from "@/public/images/about-us/ankush-jagga.png";
...
export const partnersPage = {
  ...
  metricsSection: {
    ...
    description:
      "Ai and augmented reality are rapidly becoming core to how enterprises operate and scale. I partnering early means aligning with a high-growth market and delivering measurable value to your customers.",
    metrics_card_data: [
      {
        title: "51.8% CAGR",
        description:
